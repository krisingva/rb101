...
#   condition evaluates to false. until iterates until the condition evaluates
#   to true. In this case, the condition evaluates to true when count equals 0.
#   We want it to be the opposite though. We would like until to iterate until
#   count is greater than 10. We use greater than here so 10 is included in the
#   output. If we used ==, then 9 would be the last number printed.
