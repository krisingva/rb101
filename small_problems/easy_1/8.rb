...
# Algorithm: Add up all the elements of integer for the sum. Count the number of
# elements. Divide the sum with the count.
...
# could also be done with numbers.reduce(:+)
#   sum / numbers.count
# end
