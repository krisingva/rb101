...
# Algorithm: Convert string to array delimited by spaces. Count the characters in each element of array and reverse the word if 5 or more. Convert back to string. 
