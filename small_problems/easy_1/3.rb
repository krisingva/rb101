...
# Algorithm: take an integer and convert to string, then split string into
# separate digits, transform string digits into number digits
...
# str.each_char.to_a. If a block is given, which is a deprecated form, works the
# same as each_char.
...
# Takes 12345, divides by 10 (equals 1234.5) and takes the floor, or removes the
# comma and rounds down, leaving 1234 and the remainder 5. The remainder is put
# into the beginning of the digits array. Loops until integer reaches 0.
