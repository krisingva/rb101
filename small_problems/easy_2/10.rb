...
# previous line mutates the items in array1 that start with 'C' or 'S' but
# array2 is not affected by this code, it still contains the items from the
# original array1 collection
puts array2
...
# by Value in Lesson 2 of Programming Foundations. To be succesful with ruby,
# you must understand how values are passed around, and what mutation means for
# those values.

# Further Exploration
# How can this feature of ruby get you in trouble? How can you avoid it?
# When working with collections, you would have to take care not to have
# separate collections containing items that point to the same objects. Rather,
# you should make copies of the objects and have the items point to the copies.