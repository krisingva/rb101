...
# 1 = 2, the 4th is 1 + 2 = 3, the 5th is 2 + 3 = 5, and so on. In mathematical
# terms:
...
# description of the problem that the method should return 1 for the 1st and 2nd
# Fibonacci numbers, so we make that our ending condition.
...
# A Diversion
# This section touches on an advanced topic. You may ignore it for now but read
# on if you're curious.

# If you've worked with recursion before, you may be familiar with something
# called "tail recursion." Without going into detail, tail recursion is a way to
# write recursive methods so the language processor can optimize it better; this
# often leads to faster solutions, and the ability to recurse more "deeply." The
# solutions are often harder to understand, though.
