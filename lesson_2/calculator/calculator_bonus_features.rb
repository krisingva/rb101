...
loop do # main loop
  ...
  operator_prompt = <<-MSG # ruby Heredoc
  ...
  # since the result variable is created within the if condition
  # (which does not create a block), the variable is visible outside
