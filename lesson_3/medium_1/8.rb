...
# start with the inner most rps calls: rps("rock", "paper") gives "paper" and
# rps("rock", "scissors") gives "rock" which leaves: rps(rps("paper", "rock"),
# "rock") then evaluate the next inner most: rps("paper", "rock") gives "paper"
# which leaves: rps("paper", "rock") which gives "paper"
