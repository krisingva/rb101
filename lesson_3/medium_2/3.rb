...
# My answer: The string will remain the same after the method because String#+=
# is not mutating, it acts as assignment. The array will be mutated by the
# method because the Array#<< method is mutating, it will add the "rutabaga"
# string to the end of the array which will then contain two items instead of
# one.

# LS Solution: Our output will look like this:

# My string looks like this now: pumpkins
# My array looks like this now: ["pumpkins", "rutabaga"]
# Why? It seems clear from the above that Ruby treats string and array
# parameters differently...but not so fast. Actually the parameters are treated
# in exactly the same way...but the results are different.
...
# string parameter is passed to the method as a reference to an object of type
# String. Similarly, the array is passed to the method as a reference to an
...
# keeps using the same object that was passed in, and appends the new element to
# it.
...
# the same object, and we see the results of what happened to the array
